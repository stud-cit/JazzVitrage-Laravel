...
=======
                    <router-link :to="{ name: 'jury-evaluation', params: {id: item.application_id} }">{{ `${item.solo_duet[0].name} ${item.solo_duet[0].surname} ${item.solo_duet[0].patronymic}` }}</router-link>
                </td>
                <td v-if="item.solo_duet.length == 2">
                    <router-link :to="{ name: 'jury-evaluation', params: {id: item.application_id} }">{{ `${item.solo_duet[0].name} ${item.solo_duet[0].surname} ${item.solo_duet[0].patronymic}` }}, <br> {{ `${item.solo_duet[1].name} ${item.solo_duet[1].surname} ${item.solo_duet[1].patronymic}` }}</router-link>

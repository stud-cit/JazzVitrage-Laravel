    ...
    <div class="row">
  	    <div class="col-sm-4">
            ...
            <ul class="list-group">
                ...
                <li v-show="data.role == 'jury'" class="list-group-item text-right"><span class="pull-left"><strong>Звання </strong></span> {{ data.rank }}</li>
                <li v-show="data.role == 'jury'" class="list-group-item text-right"><span class="pull-left"><strong>Номінація</strong></span> {{ data.nominations }}</li>
            </ul> 
        </div>
